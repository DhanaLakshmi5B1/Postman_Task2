...
## APIs Tested
1. POST Login API (Authentication)  
...
## Files in Repository
* CODETECH API Testing.postman_collection.json  
...
The Login API returned a success response, and the GET Users API confirmed data retrieval.  
